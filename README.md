...
<p align="center">
  <strong>NekoSoft Founder &amp; Lead Developer</strong><br />
  <sub>Building NekoAntiXray &amp; Nekovideo · Java · Python · C/C++</sub>
</p>
...
<table>
  <tr>
    ...
    <td width="48%" valign="top">
      <h3>现在专注</h3>
      <ul>
        <li>高性能 Java 服务端与插件生态</li>
        <li>NekoAntiXray、Nekovideo 等项目</li>
        <li>Python 自动化与 C/C++ 底层能力</li>
        <li>开源协作、架构设计与可观测性</li>
      </ul>
    </td>
  </tr>
</table>
...
<p align="center">
  <i>繁星不怕被看作流萤 · Keep learning, keep shipping ✨</i>
</p>
